      ...
      <Container className="">
        <Row>
          <Col lg="4" className="mb-4" md="6">
            ...
            <p className="footer__text mt-4">Trusted as promised.</p>
          </Col>
          ...
          <Col lg="12" className="mb-4">
            <p className="footer__copyright">
              gear5 &copy; {year}
              <br /> Developed by Prem Dhananjayan & Jithin Mohan - III Sem MCA
              <br />
              For Enterprise Computing Project Submission.
              <br />
              All Rights Reserved.
            </p>
          </Col>
